...
(function ($, undefined) {
    ...
    /**
     * filter mouse events so an event is fired only if the mouse moved.
     *
     * filter out mouse events that occur when mouse is stationary but
    ...
    $.fn.select2.defaults = {
        ...
        formatNoMatches: function () { return "没有找到"; },
        formatInputTooShort: function (input, min) { var n = min - input.length; return "请输入 " + n + " 字符" + (n == 1? "" : ""); },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "请删除 " + n + " 字符" + (n == 1? "" : ""); },
        formatSelectionTooBig: function (limit) { return "You can only select " + limit + " item" + (limit == 1 ? "" : "s"); },
        formatLoadMore: function (pageNumber) { return "加载更多..."; },
